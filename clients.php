...
?>
    ...
    <a href="addclient.php" class="btn btn-outline-primary" style="float:right;margin-bottom:20px">
    ...
    <table id="datatable" class="display">
        ...
        <tbody>
            <tr>
                ...
                <!-- Boutton modifier -->
                <td>
                    <a href="modifClient.php?id=<?php echo $ligne["idclient"] ?>" class="btn btn-outline-success">
            ...
            <!-- BOUTTON -->            
                    <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#deleteModal<?php echo $count?>">
